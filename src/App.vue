<template>
  <section class="ly_broadcasting_area" v-if="isHomePage && auth && isLive && liveData">
        ...
        <div class="full_content">
          ...
          <div class="inner view_product">
            <div class="inner_content product_details_list" id="Items">
              ...
              <button v-if="auth" class="cms_sold_cart" @click.prevent="addToCart"> Add To Cart </button>
            </div>
...
export default {
  ...
  methods: {
    ...
    showCartStatus(){
      this.axios.get('/api/comment/'+this.auth+'/cart')
          .then((response) => {
            window.$(".header_cart a span").html(response.data)
          })
    },
